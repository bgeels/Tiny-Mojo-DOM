package Tiny::Mojo::DOM;
use Tiny::Mojo::Base -strict;
use overload
...
use Carp 'croak';
use Tiny::Mojo::Collection;
use Tiny::Mojo::DOM::CSS;
use Tiny::Mojo::DOM::HTML;
...
sub content {
  ...
  if ($type eq 'root' || $type eq 'tag') {
    ...
    my $html = Tiny::Mojo::DOM::HTML->new(xml => $self->xml);
...
sub new {
  my $class = shift;
  my $self = bless \Tiny::Mojo::DOM::HTML->new, ref $class || $class;
...
sub tap { shift->Tiny::Mojo::Base::tap(@_) }
...
sub _collect {
  my $self = shift;
  my $xml  = $self->xml;
  return Tiny::Mojo::Collection->new(map { $self->_build($_, $xml) } @_);
}
...
sub _css { Tiny::Mojo::DOM::CSS->new(tree => shift->tree) }
...
sub _parse { Tiny::Mojo::DOM::HTML->new(xml => shift->xml)->parse(shift)->tree }
...
Tiny::Mojo::DOM - Minimalistic HTML/XML DOM parser with CSS selectors
...
=head1 SYNOPSIS
  ...
  # Parse
  my $dom = Tiny::Mojo::DOM->new('<div><p id="a">Test</p><p id="b">123</p></div>');
...
L<Tiny::Mojo::DOM> is a minimalistic and relaxed HTML/XML DOM parser with CSS
...
While all node types are represented as L<Tiny::Mojo::DOM> objects, some methods like
L</"attr"> and L</"namespace"> only apply to elements.

=head1 CASE-SENSITIVITY

L<Tiny::Mojo::DOM> defaults to HTML semantics, that means all tags and attribute
names are lowercased and selectors need to be lowercase as well.

  # HTML semantics
  my $dom = Tiny::Mojo::DOM->new('<P ID="greeting">Hi!</P>');
...
mode and everything becomes case-sensitive.
  ...
  # XML semantics
  my $dom = Tiny::Mojo::DOM->new('<?xml version="1.0"?><P ID="greeting">Hi!</P>');
  say $dom->at('P[ID]')->text;

XML detection can also be disabled with the L</"xml"> method.

  # Force XML semantics
  my $dom = Tiny::Mojo::DOM->new->xml(1)->parse('<P ID="greeting">Hi!</P>');
  say $dom->at('P[ID]')->text;

  # Force HTML semantics
  my $dom = Tiny::Mojo::DOM->new->xml(0)->parse('<P ID="greeting">Hi!</P>');
  say $dom->at('p[id]')->text;

=head1 METHODS

L<Tiny::Mojo::DOM> implements the following methods.
...
L<Tiny::Mojo::Collection> object containing these elements as L<Tiny::Mojo::DOM> objects.
All selectors from L<Tiny::Mojo::DOM::CSS/"SELECTORS"> are supported.
...
=head2 append
  ...
  $dom = $dom->append('<p>I ♥ Tiny::Mojolicious!</p>');
...
=head2 append_content
  ...
  $dom = $dom->append_content('<p>I ♥ Tiny::Mojolicious!</p>');
...
return it as a L<Tiny::Mojo::DOM> object, or C<undef> if none could be found. All
selectors from L<Tiny::Mojo::DOM::CSS/"SELECTORS"> are supported.
...
Return a L<Tiny::Mojo::Collection> object containing all child nodes of this element
as L<Tiny::Mojo::DOM> objects.
...
=head2 content
  ...
  my $str = $dom->content;
  $dom    = $dom->content('<p>I ♥ Tiny::Mojolicious!</p>');
...
Return a L<Tiny::Mojo::Collection> object containing all descendant nodes of this
element as L<Tiny::Mojo::DOM> objects.
...
return a L<Tiny::Mojo::Collection> object containing these elements as L<Tiny::Mojo::DOM>
objects. All selectors from L<Tiny::Mojo::DOM::CSS/"SELECTORS"> are supported.
...
a L<Tiny::Mojo::Collection> object containing these elements as L<Tiny::Mojo::DOM> objects.
All selectors from L<Tiny::Mojo::DOM::CSS/"SELECTORS"> are supported.
...
Return a L<Tiny::Mojo::Collection> object containing all sibling nodes after this
node as L<Tiny::Mojo::DOM> objects.
...
L<Tiny::Mojo::DOM::CSS/"SELECTORS"> are supported.
...
=head2 new
  ...
  my $dom = Tiny::Mojo::DOM->new;
  my $dom = Tiny::Mojo::DOM->new('<foo bar="baz">I ♥ Tiny::Mojolicious!</foo>');

Construct a new scalar-based L<Tiny::Mojo::DOM> object and L</"parse"> HTML/XML
...
Return L<Tiny::Mojo::DOM> object for next sibling element, or C<undef> if there are no
more siblings.
...
Return L<Tiny::Mojo::DOM> object for next sibling node, or C<undef> if there are no
more siblings.
...
Return L<Tiny::Mojo::DOM> object for parent of this node, or C<undef> if this node has
no parent.
...
=head2 parse
  ...
  $dom = $dom->parse('<foo bar="baz">I ♥ Tiny::Mojolicious!</foo>');

Parse HTML/XML fragment with L<Tiny::Mojo::DOM::HTML>.

  # Parse XML
  my $dom = Tiny::Mojo::DOM->new->xml(1)->parse('<foo>I ♥ Tiny::Mojolicious!</foo>');
...
Return a L<Tiny::Mojo::Collection> object containing all sibling nodes before this
node as L<Tiny::Mojo::DOM> objects.
...
=head2 prepend
  ...
  $dom = $dom->prepend('<p>I ♥ Tiny::Mojolicious!</p>');
...
=head2 prepend_content
  ...
  $dom = $dom->prepend_content('<p>I ♥ Tiny::Mojolicious!</p>');
...
Return L<Tiny::Mojo::DOM> object for previous sibling element, or C<undef> if there
...
Return L<Tiny::Mojo::DOM> object for previous sibling node, or C<undef> if there are
no more siblings.
...
=head2 replace
  ...
  my $parent = $dom->replace('<div>I ♥ Tiny::Mojolicious!</div>');
...
Return L<Tiny::Mojo::DOM> object for C<root> node.
...
Alias for L<Tiny::Mojo::Base/"tap">.
...
L<Tiny::Mojo::DOM> overloads the following operators.
...
L<Tiny::Mojolicious>, L<Tiny::Mojolicious::Guides>, L<http://mojolicious.org>.
