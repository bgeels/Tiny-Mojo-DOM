...
# Declared here to avoid circular require problems in Tiny::Mojo::Util
sub _monkey_patch {
  my ($class, %patch) = @_;
  no strict 'refs';
...
Tiny::Mojo::Base - Minimal base class for Tiny::Mojo projects

=head1 SYNOPSIS

  package Cat;
  use Tiny::Mojo::Base -base;

  has name => 'Nyan';
  has ['age', 'weight'] => 4;

  package Tiger;
  use Tiny::Mojo::Base 'Cat';
...
L<Tiny::Mojo::Base> is a simple base class for L<Tiny::Mojo> projects with fluent
interfaces.

  # Automatically enables "strict", "warnings", "utf8" and Perl 5.10 features
  use Tiny::Mojo::Base -strict;
  use Tiny::Mojo::Base -base;
  use Tiny::Mojo::Base 'SomeBaseClass';
...
All three forms save a lot of typing.
  ...
  use IO::Handle ();
  use Tiny::Mojo::Base;
  push @ISA, 'Tiny::Mojo::Base';
  sub has { Tiny::Mojo::Base::attr(__PACKAGE__, @_) }
...
L<Tiny::Mojo::Base> implements the following functions, which can be imported with
...
L<Tiny::Mojo::Base> implements the following methods.
