package Tiny::Mojo::DOM::CSS;
use Tiny::Mojo::Base -base;

use Tiny::Mojo::Util 'trim';
...
Tiny::Mojo::DOM::CSS - CSS selector engine
...
=head1 SYNOPSIS
  ...
  my $css = Tiny::Mojo::DOM::CSS->new(tree => $tree);
  my $elements = $css->select('h1, h2, h3');

=head1 DESCRIPTION

L<Tiny::Mojo::DOM::CSS> is the CSS selector engine used by L<Tiny::Mojo::DOM>, based on the
...
L<Tiny::Mojo::DOM::CSS> implements the following attributes.
...
L<Tiny::Mojo::DOM::CSS> inherits all methods from L<Tiny::Mojo::Base> and implements the
following new ones.
