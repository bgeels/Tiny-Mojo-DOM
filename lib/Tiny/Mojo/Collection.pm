...
sub join {
  Tiny::Mojo::ByteStream->new(join $_[1] // '', map {"$_"} @{$_[0]});
}
...
Tiny::Mojo::Collection - Collection
...
=head1 SYNOPSIS
  ...
  my $collection = Tiny::Mojo::Collection->new(qw(just works));
  ...
  use Tiny::Mojo::Collection 'c';
  c(qw(a b c))->join('/')->url_escape->say;

=head1 DESCRIPTION

L<Tiny::Mojo::Collection> is an array-based container for collections.

  # Access array directly to manipulate collection
  my $collection = Tiny::Mojo::Collection->new(1 .. 25);
  $collection->[23] += 100;
  say for @$collection;

=head1 FUNCTIONS

L<Tiny::Mojo::Collection> implements the following functions, which can be imported
individually.
...
Construct a new array-based L<Tiny::Mojo::Collection> object.

=head1 METHODS

L<Tiny::Mojo::Collection> implements the following methods.
...
string.
  ...
  # "0, 1, 2, 3"
  Tiny::Mojo::Collection->new(0, 1, undef, 2, '', 3)->compact->join(', ');
...
all elements.
  ...
  # "1, 2, 3, 4, 5, 6, 7"
  Tiny::Mojo::Collection->new(1, [2, [3, 4], 5, [6]], 7)->flatten->join(', ');
...
Turn collection into L<Tiny::Mojo::ByteStream>.
...
=head2 new
  ...
  my $collection = Tiny::Mojo::Collection->new(1, 2, 3);
...
Create a new collection with all selected elements.
  ...
  # "B C E"
  Tiny::Mojo::Collection->new('A', 'B', 'C', 'D', 'E')->slice(1, 2, 4)->join(' ');
...
callback/method.
  ...
  # "foo bar baz"
  Tiny::Mojo::Collection->new('foo', 'bar', 'bar', 'baz')->uniq->join(' ');

  # "[[1, 2], [2, 1]]"
  Tiny::Mojo::Collection->new([1, 2], [2, 1], [3, 2])->uniq(sub{ $_->[1] })->to_array;
